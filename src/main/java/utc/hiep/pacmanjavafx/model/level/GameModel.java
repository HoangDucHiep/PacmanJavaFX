...
public interface GameModel {
        ...
        byte[][] RAW_LEVEL_DATA = {
                /* 1*/ { 80, 75, 40,  20,  80, 10,  85,  90, 50},
                /* 2*/ { 90, 85, 45,  30,  90, 15,  95,  95, 55},
                /* 3*/ { 90, 85, 45,  40,  90, 20,  95,  95, 55},
                /* 4*/ { 90, 85, 45,  40,  90, 20,  95,  95, 55},
                /* 5*/ {100, 95, 50,  40, 100, 20, 105, 100, 60},
                /* 6*/ {100, 95, 50,  50, 100, 25, 105, 100, 60},
                /* 7*/ {100, 95, 50,  50, 100, 25, 105, 100, 60},
                /* 8*/ {100, 95, 50,  50, 100, 25, 105, 100, 60},
                /* 9*/ {100, 95, 50,  60, 100, 30, 105, 100, 60},
                /*10*/ {100, 95, 50,  60, 100, 30, 105, 100, 60},
                /*11*/ {100, 95, 50,  60, 100, 30, 105, 100, 60},
                /*12*/ {100, 95, 50,  80, 100, 40, 105, 100, 60},
                /*13*/ {100, 95, 50,  80, 100, 40, 105, 100, 60},
                /*14*/ {100, 95, 50,  80, 100, 40, 105, 100, 60},
                /*15*/ {100, 95, 50, 100, 100, 50, 105, 100, 60},
                /*16*/ {100, 95, 50, 100, 100, 50, 105, 100, 60},
                /*17*/ {100, 95, 50, 100, 100, 50, 105,   0,  0},
                /*18*/ {100, 95, 50, 100, 100, 50, 105, 100, 60},
                /*19*/ {100, 95, 50, 120, 100, 60, 105,   0,  0},
                /*20*/ {100, 95, 50, 120, 100, 60, 105,   0,  0},
                /*21*/ { 90, 95, 50, 120, 100, 60, 105,   0,  0},
        };
