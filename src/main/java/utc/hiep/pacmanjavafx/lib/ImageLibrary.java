...
public class ImageLibrary {
    ...
    public static Image FLASHING_MAZE = new Image(Objects.requireNonNull(ImageLibrary.class.getResourceAsStream(FLASHING_MAZE_PATH)), 448, 496, false, true);
    public static Image PACMAN_SPRITE = new Image(Objects.requireNonNull(ImageLibrary.class.getResourceAsStream(PACMAN_SPRITE_PATH)));
