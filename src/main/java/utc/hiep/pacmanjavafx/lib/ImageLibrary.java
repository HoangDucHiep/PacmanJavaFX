...
public class ImageLibrary {
    ...
    private static final String ENERGIZER_PATH = "asserts/graphics/energizer.png";
    ...
    public static Image ENERGIZER = new Image(Objects.requireNonNull(ImageLibrary.class.getResourceAsStream(ENERGIZER_PATH)));
}
